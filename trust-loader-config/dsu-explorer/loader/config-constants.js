let LOADER_GLOBALS = {
  ...
  <hr/>
	...
	WALLET_BUILDER_SERVICE:{
		WALLET_TEMPLATE_FOLDER_NAME: "../external-volume/wallets/dsu-explorer/wallet-patch",
		APPS_TEMPLATE_FOLDER_NAME: "../external-volume/wallets/dsu-explorer/apps-patch"
	}
};
