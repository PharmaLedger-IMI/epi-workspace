...
export const translations = {
  ...
  "es": {
    ...
    "camera_error_message": "Algo salió mal y no se puede acceder correctamente a la cámara seleccionada. Compruebe la configuración de la cámara de su dispositivo o intente cambiar la cámara desde el menú.",
    "leaflet_lang_select_message": "El prospecto no está disponible en su idioma preferido. También puede elegir una opción de la lista.",
    "lang_proceed": "Continuar",
    "go_home": "Vuelver al Inicio",
    "onboarding_welcome": "¡Ya casi! <br>Por favor lea y acepte los términos y condiciones.",
    ...
    "privacy_content": "<h1><b>Aviso de Privacidad</b></h1> <p>Este aviso de privacidad es aplicable al uso del producto de información electrónica de productos de la Asociación PharmaLedger </p>. <h2>Contactos</h2><p><b>a) Identidad y contactos del controlador o controladores conjuntos</b></p><p>El controlador de sus datos es la Asociación PharmaLedger</p>. <p><b>b) Contactos del oficial de protección de datos</b></p><p>La Oficina de Protección de Datos de la Asociación PharmaLedger se puede contactar en <a href=\"mailto: dpo@pharmaledger.org\"> dpo@pharmaledger.org</a> </p><h2>Qué datos personales utilizamos</h2><p>Recopilamos solo los datos técnicos necesarios para entregar su prospecto electrónico. Esto incluye su dirección IP e identificadores técnicos del dispositivo y navegador que utiliza para acceder a nuestra aplicación.</p> <p><em>En detalle, recopilamos los siguientes elementos de datos</em></p><ul><li><p><em>Acceso Dispositivos Móviles.</em> Podemos solicitar acceso o permiso a ciertas funciones desde su dispositivo móvil, incluida la cámara de su dispositivo móvil, y otras funciones. Si desea cambiar nuestro acceso o permisos, puede hacerlo en la configuración de su dispositivo.</p></li><li><p><em> Información de Dispositivo Móvil.</em> Recopilamos automáticamente información del dispositivo (como su ID de dispositivo móvil, modelo y fabricante), sistema operativo, información de versión e información de configuración del sistema, números de identificación del dispositivo y la aplicación, tipo y versión del navegador, modelo de hardware, proveedor de servicios de Internet y/o operador de telefonía móvil, y dirección de Protocolo de Internet (IP) (o servidor proxy). Si está utilizando nuestra(s) aplicación(es), también podemos recopilar información sobre la red telefónica asociada con su dispositivo móvil, el sistema operativo o la plataforma de su dispositivo móvil, el tipo de dispositivo móvil que utiliza, el ID de dispositivo único de su dispositivo móvil e información sobre las características de nuestra(s) aplicación(es) a las que accedió.</p></li></ul><h2>Por qué recopilamos sus datos personales</h2><p><b>Propósitos </b></p><p>Recopilamos sus datos técnicos con el fin de proporcionarle un prospecto electrónico del producto para su medicamento. </p><p>Como tal, podemos confiar en las siguientes bases legales para procesar su información personal:</p><ul><li><p><b>Ejecución de un Contrato.</b> Podemos procesar su información personal cuando creemos que es necesario para cumplir con las obligaciones contractuales con usted, incluida la prestación de nuestros Servicios o a su solicitud antes de celebrar un contrato con usted.</p></li><li><p><b> Obligaciones Legales.</b> Podemos procesar su información cuando creemos que es necesario para el cumplimiento de nuestras obligaciones legales, como para cumplir con nuestras obligaciones en virtud de la regulación de la salud y la legislación de salud pública.</p></li></ul><h2>Con quién compartimos sus datos personales</h2><p> Empresas miembros y proveedores de servicios externos.</p><p>Compartimos sus datos con proveedores externos, proveedores de servicios, contratistas o agentes (\"terceros\") que realizan servicios para nosotros o en nuestro nombre y requieren acceso a dicha información para realizar ese trabajo. Tenemos contratos vigentes con nuestros terceros, que están diseñados para ayudar a salvaguardar su información personal. Esto significa que no pueden hacer nada con su información personal a menos que les hayamos indicado que lo hagan. Tampoco compartirán su información personal con ninguna organización aparte de nosotros. También se comprometen a proteger los datos que tienen en nuestro nombre y a conservarlos durante el período que le indiquemos. Las categorías de terceros con los que podemos compartir información personal son las siguientes:</p><ul><li><p> Fabricantes de medicamentos (Empresas Miembro)</p></li><li><p> Proveedores de Servicios Técnicos</p></li></ul><h2>Cuánto tiempo almacenamos sus datos personales</h2><p>La Asociación PharmaLedger solo almacena sus datos técnicos durante el tiempo que sea necesario para procesar su solicitud de prospecto durante un máximo de 30 días. </p><p>Su fabricante de medicamentos también almacenará sus datos durante un período de tiempo definido según lo determinado por sus políticas de retención de datos, para obtener más información sobre esta retención, comuníquese con su fabricante de medicamentos.</p><h2>Si no nos proporciona sus datos personales</h2><p>Si decide no proporcionarnos sus datos técnicos, no podremos cumplir con su solicitud de prospecto.</p><h2>Sus derechos</h2><p>Si tiene alguna solicitud relacionada con sus datos personales en virtud del GDPR, como una solicitud para acceder o eliminar sus datos, puede contactarnos en <a href=\"mailto:dpo@pharmaledger.org\">dpo@pharmaledger.org</a>.</p><p>Procesaremos dichas solicitudes en un plazo de 30 días</p><h2>Retiro de consentimiento</h2><p>Si tiene alguna solicitud relacionada con sus datos personales en virtud del GDPR, como una solicitud para acceder o eliminar sus datos, puede contactarnos en <a href=\"mailto:dpo@pharmaledger.org\">dpo@pharmaledger.org</a>.</p><p>.</p><p>Procesaremos dichas solicitudes en un plazo de 30 días</p><h2>Toma de decisiones automatizada</h2><p>No utilizamos ninguna toma de decisiones automatizada en nuestro suministro de este servicio a usted.</p>Transferencia Internacional de Datos Personales</h2><p>Cuando su fabricante de medicamentos nos exige que transfiramos sus datos fuera de la Unión Europea, utilizamos cláusulas contractuales estándar para proteger sus datos.</p><h2>Cómo quejarse</h2><p>Si tiene alguna solicitud relacionada con sus datos personales en virtud del GDPR, como una solicitud para acceder o eliminar sus datos, puede contactarnos en <a href=\"mailto:dpo@pharmaledger.org\">dpo@pharmaledger.org</a>.</p><p>Procesaremos dichas solicitudes en un plazo de 30 días Además, puede ponerse en contacto con su autoridad de supervisión local si considera que no se están cumpliendo sus derechos.</p>",
    ...
    "terms_content": "<h2>Términos y condiciones para el sitio web y la aplicación de información electrónica de productos de la Asociación PharmaLedger </h2><p>Al acceder o utilizar el sitio web y la aplicación de información electrónica de productos de la Asociación PharmaLedger (los \"Servicios\"), usted acepta estar sujeto a estos términos y condiciones (los \"Términos\"). No puede acceder ni utilizar los Servicios si no está de acuerdo con estos Términos. Los Servicios son operados por la Asociación PharmaLedger (la \"Asociación\") y están destinados a ser utilizados por personas que buscan información sobre su medicamento. Una red multiparte ofrece los Servicios, y su fabricante de medicamentos suministra la información del producto que se muestra a través de los Servicios. La Asociación actúa como controlador de datos para esta información. </p><h2>Uso de los Servicios </h2><p>Usted acepta utilizar los Servicios solo para fines legales y de una manera que no infrinja los derechos de, o restrinja o inhiba el uso y disfrute de los Servicios por parte de terceros. Dicha restricción o inhibición incluye, sin limitación, conductas que son ilegales, o que pueden acosar o causar angustia o inconvenientes a cualquier persona, y la transmisión de contenido obsceno u ofensivo o la interrupción del flujo normal de diálogo dentro de los Servicios. </p><h2>Propiedad intelectual </h2><p>El contenido de los Servicios, incluidos, entre otros, texto, gráficos, imágenes y software, es propiedad de la Asociación o sus licenciantes y compañías miembros y está protegido por derechos de autor y otras leyes de propiedad intelectual. No puede utilizar ningún contenido de los Servicios para ningún propósito comercial sin el consentimiento expreso por escrito de la Asociación. </p><h2>Responsabilidad</h2><p>La Asociación no hace ninguna representación o garantía de ningún tipo, expresa o implícita, en cuanto al funcionamiento de los Servicios o la información, contenido, materiales o productos incluidos en los Servicios. La Asociación no será responsable de ningún daño de ningún tipo que surja del uso de los Servicios, incluidos, entre otros, daños directos, indirectos, incidentales, punitivos y consecuentes. </p><h2>Legislación Aplicable </h2><p>Estos Términos y su uso de los Servicios se regirán e interpretarán de acuerdo con las leyes de Suiza y cualquier disputa se resolverá en los tribunales de Basilea, Suiza. </p><h2>Cambios en los Términos </h2><p>La Asociación se reserva el derecho de cambiar estos Términos en cualquier momento, y usted es responsable de verificar estos Términos periódicamente para detectar cualquier cambio. Su uso continuado de los Servicios después de que se hayan realizado cambios en los Términos constituirá su aceptación de los Términos revisados.</p><p><br></p>",
    "about_modal_subtitle": "Acerca de",
    "about_modal_title": "PharmaLedger",
    "about_content": "<iframe style=\"width: 100%; height: 100%; margin-bottom: 24px; border: 0\" src=\"https://pharmaledger.org\"></iframe>",
    "help_modal_title": "Ayuda",
    "help_modal_subtitle": "Preguntas frecuentes",
    "help_content": "<div><p><b>¿Qué es EPI?</b></p><p><b>EPI</b> es la abreviatura de <b>información electronica de producto</b>. Es una versión electrónica del prospecto de información del producto en papel que normalmente se encuentra dentro de un paquete de productos farmacéuticos. En algunos casos, el <b>EPI</b> puede haber reemplazado el prospecto de papel.</p> <p> <b >¿Qué es PharmaLedger?</b></p><p>La Asociación PharmaLedger (PLA) es una asociación sin fines de lucro con sede en Suiza con el propósito de habilitar y fomentar un ecosistema de confianza digital en la atención médica a través de una plataforma de código abierto estandarizada y confiable. PLA promueve la colaboración y acelera la innovación y la adopción para lograr beneficios mutuos en los dominios de la salud y las ciencias de la vida para los pacientes y otras partes interesadas. PLA se formó en 2022 para continuar el trabajo del proyecto PharmaLedger, un proyecto de 3 años financiado por la Comisión Europea y la industria farmacéutica destinado a demostrar el valor de las soluciones blockchain. Más información disponible en https://pharmaledger.org/ </p> <p><b>¿Qué es DataMatrix?</b> </p> <p>Es un tipo de código de barras en su paquete de productos.  Es un código de barras de caja cuadrada en blanco y negro y se verá similar a esto:<br> <img src=\"./images/barcode_example.png\"></p> <p> <b>¿Cómo usar la App?</b></p><p>Siga las instrucciones en la página de destino de la <b>Aplicación...</b> muestra una imagen de dónde encontrar <b>DataMatrix</b> en su paquete de productos. Una vez que haya encontrado <b>DataMatrix</b>, haga clic en el botón 'Escanear <b>DataMatrix</b>'. Permita que la aplicación use la cámara para que se pueda escanear <b>DataMatrix</b>. Utilice la cámara para enfocar la <b>DataMatrix</b>. Una vez que el paquete se escanea con éxito, se mostrará el <b>EPI</b>. Puede hacer clic en el botón ‘+’ para obtener más detalles. </p><p><b>¿Por qué mi escaneo DataMatrix no da un resultado?</b></p><p> Hay varias razones por las que <b>DataMatrix</b> en su paquete puede no dar una EPI. Una de las razones podría ser el enfoque de la cámara. Por favor, intente escanear el código en un lugar bien iluminado y que el código se encuentre claramente visible en la pantalla. Si usted está teniendo problemas para mantener su mano firme, usted podría tratar de usar una mesa para apoyar sus manos. </p></div>"
  },
  "pt": {
  ...
  "ko": {
    ...
    "scan_explain": "약품상의 데이터 매트릭스 바코드(DataMatrix Barcode)를 스캔하여 자세한 정보를 확인할 수 있습니다.",
    ...
    "leaflet_expired_message": "<p> <b>이 제품은 만료된 것으로 확인되었습니다.</b> </p> ",
    ...
    "leaflet_lang_select_message": "본 리플릿은 사용자 선호 언어가 제공되지 않습니다. 사용 가능한 언어 목록 중에서 언어를 선택해주세요.",
    "lang_proceed": "진행",
    "go_home": "돌아가기",
    ...
    "about_modal_title": "파마레저(PharmaLedger)",
    "about_content": "<iframe style=\"width: 100%; height: 100%; margin-bottom: 24px; border: 0\" src=\"https://pharmaledger.org\"></iframe>",
    "help_modal_title": "도움",
    "help_modal_subtitle": "자주 묻는 질문",
    "help_content": "<div><p><b>EPI는 무엇인가요?</b></p><p><b>EPI</b>는electronic product information (전자 제품 정보)의 약어입니다. 이것은 일반적으로 제약 제품 패키지에서 찾을 수 있는 종이로 된 제품 정보의 전자 버전입니다. 경우에 따라 <b>EPI</b>가 용지 리플릿을 교체했을 수 있습니다.</p><p><b>PharmaLedger는 무엇인가요?</b></p><p>PLA(PharmaLedger Association)는 표준화되고 신뢰할 수 있는 오픈 소스 플랫폼을 통해 의료 분야의 디지털 신뢰 생태계를 활성화하고 육성하기 위한 목적으로 스위스에 기반을 둔 비영리 단체입니다. PLA는 협업을 촉진하고 혁신과 채택을 가속화하여, 환자 및 기타 이해 관계자를 위한 의료 및 생명 과학 분야에서 상호 이익을 달성합니다. PLA는 블록체인 솔루션의 가치를 입증하기 위해 유럽연합 집행위원회와 제약업계가 자금을 지원하는 3년 프로젝트인 PharmaLedger 프로젝트 작업을 지속하기 위해 2022년에 설립되었습니다. 자세한 내용은https://pharmaledger.org/ 에서 확인할 수 있습니다</p><p><b>DataMatrix는 무엇인가요?</b></p><p>제품 패키지에 있는 바코드입니다.  이 바코드는 검은색과 흰색 사각형 상자 바코드이며 다음과 유사합니다:<br><img src=\"./images/barcode_example.png\"></p><p><b>앱을 어떻게 사용합니까?</b></p><p>앱의 랜딩 페이지에 있는 지침을 따릅니다… 여기에는 제품 패키지에서 데이터 매트릭스를 찾을 수 있는 위치의 그림이 표시됩니다. 데이터 매트릭스를 찾았으면 '데이터 매트릭스 스캔하기' 버튼을 클릭합니다. 응용 프로그램이 카메라를 사용하여 데이터 매트릭스를 스캔할 수 있도록 하십시오. 카메라를 사용하여 데이터 매트릭스에 초점을 맞춥니다. 팩이 성공적으로 스캔되면 EPI가 표시됩니다. '+' 버튼을 클릭하면 자세한 정보를 볼 수 있습니다</p><p><b>왜 데이터 매트릭스가 결과를 제공하지 않는 것입니까?</b></p><p>패키지의 DataMatrix가 EPI를 제공하지 않는 것에는 몇 가지 이유가 있습니다. 그 중 하나는 카메라의 초점 때문일 수 있습니다. 화면에 잘 보이는 곳에서 코드를 스캔하고 코드가 잘 보이도록 하십시오.  만약 안정적으로 스캔하기가 어려울 경우에는 테이블을 사용해 손을 지탱해보세요.</p></div>"
  }
}
