...
export const translations = {
  ...
  "ar": {
    ...
    "help_content": "ما هوEPI ؟ \n" +
        " EPIهو اختصار لمعلومات المنتج الإلكترونية. إنها نسخة إلكترونية من نشرة معلومات المنتج الورقية التي تجدها عادةً داخل عبوة المنتج الصيدلاني. في بعض الحالات، قد تحل نسخة EPI محل النشرة الورقية.\n" +
        "\n" +
        "<b>ما هو فارما ليدجر؟</b>\n" +
        "جمعية فارما ليدجر (PLA) هي جمعية غير هادفة للربح مقرها سويسرا، تهدف إلى تمكين وتعزيز الثقة الرقمية للنظام البيئي في مجال الرعاية الصحية من خلال منصة مفتوحة المصدر موحدة وموثوقة. تعزز PLA التعاون وتسريع الابتكار وتبني الأفكار لتحقيق فوائد متبادلة في مجالات الرعاية الصحية والعلوم الحياتية للمرضى والأشخاص ذات العلاقة. تم تشكيل PLA في عام 2022 لمواصلة عمل مشروع فارما ليدجر، وهو مشروع مدته 3 سنوات تموله المفوضية الأوروبية والصناعات الدوائية، ويهدف إلى إظهار أهمية حلول بلوكتشين وقيمتها. المزيد من المعلومات متوفرة عبر الموقع athttps ://pharmaledger.org/\n" +
        "\n" +
        "<b>ما هي داتا ماتركس؟</b>\n" +
        ...
        "اتبع التعليمات الموجودة على صفحة الهبوط الخاصة بالتطبيق ... حيث يتم عرض صورة لكيفية العثور على الداتا ماتركس الموجود على عبوة منتجك.  بمجرد العثور على الداتا ماتركس، انقر فوق الزر \"امسح داتا ماتركس\".  ثم اسمح للتطبيق باستخدام الكاميرا حتى يمكن مسح الداتا ماتركس.  استخدم الكاميرا لزيادة التركيز على الداتا ماتركس. فبمجرد مسح العبوة بنجاح، سيتم عرض EPI. يمكنك النقر فوق الزر \"+\" للحصول على مزيد من التفاصيل. \n" +
        "<b>لماذا لا يعطي مسح الداتا ماتركس أي نتيجة؟</b>\n" +
        "هناك عدة أسباب لعدم ظهور EPI بعد مسح الداتا ماتركس الموجود على عبوة منتجك. قد يكون أحد الأسباب هو عدم تركيز الكاميرا جيدا. يرجى محاولة مسح الكود في مكان جيد الإضاءة بحيث يكون ظاهر بوضوح على الشاشة.  إذا كنت تجد صعوبة في الحفاظ على يدك ثابتة، فيمكنك تجربة استخدام طاولة لجعلها ثابتة.\n"
  },
  "zh": {
    "app_version": "应用程序版本: ",
