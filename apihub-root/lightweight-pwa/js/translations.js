export const translations = {
  "en": {
    ...
    "gto_timeout_text": "<p>Error trying to prove that the leaflet exists. Probably your network is too slow.</p>",
    "leaflet_timeout_text": "<p>Temporary text: error trying to download the leaflet content. Likely your network is too slow.</p>",
    "url_redirect_error": "<p>We detected a possible a malicious URL. <p>Malicious URL is a link created with the purpose of promoting scams, attacks, and frauds.</p> <p> By clicking on an infected URL, you can download ransomware, virus, trojan, or any other type of malware that will compromise your machine or even your network, in the case of a company. A malicious URL can also be used to persuade you to provide sensitive information on a fake website</p>",
    "xml_parse_error": "<p>Temporary text: error trying to parse the XML content</p>",
    "xsl_parse_error": "<p>Temporary text: error trying to parse the XSL content</p>",
    ...
    "leaflet_incorrect_date_message": "<b> This product's date is incorrect</b>. <p> For your own safety, please contact the pharmacy or doctor who issued the package of medicines. </p> ",
