...
export const translations = {
  ...
  "es": {
    ...
    "scan_button": "Escanear matriz de datos",
    "cancel": "Cancelar",
    ...
    "terms_content": "<p><b>Términos y condiciones para el sitio web y la aplicación de información electrónica de productos de PharmaLedger Association </b></p><p>Al acceder o utilizar el sitio web y la aplicación de información electrónica de productos de PharmaLedger Association (la \"Servicios\"), usted acepta estar sujeto a estos términos y condiciones (los \"Términos\"). No puede acceder o utilizar los Servicios si no está de acuerdo con estos Términos. Los Servicios son operados por PharmaLedger Asociación (la \"Asociación\") y están destinados a personas que buscan información sobre sus medicamentos. Una red de múltiples partes brinda los Servicios, y el fabricante de su medicamento proporciona la información del producto que se muestra a través de los Servicios. La Asociación actúa como controlador de datos para esta información. </p><p><b>Uso de los Servicios </b></p><p>Usted acepta usar los Servicios solo para fines lícitos y de una manera que no infrinja los derechos de , o restringir o inhibir el uso y disfrute de los Servicios por parte de terceros. Dicha restricción o inhibición incluye, sin limitación, conducta que sea ilegal o que pueda acosar o causar angustia o molestias a cualquier persona, y la transmisión de contenido obsceno u ofensivo o la interrupción del flujo normal de diálogo dentro de los Servicios. </p><p><b>Propiedad intelectual </b></p><p>El contenido de los Servicios, incluidos, entre otros, textos, gráficos, imágenes y software, es propiedad de la Association o sus licenciantes y empresas miembros y está protegida por derechos de autor y otras leyes de propiedad intelectual. No puede usar ningún contenido de los Servicios para ningún propósito comercial sin el consentimiento expreso por escrito de la Asociación. </p><p><b>Responsabilidad</b> </p><p>La Asociación no hace representaciones ni garantías de ningún tipo, expresas o implícitas, en cuanto a la operación de los Servicios o la información, contenido, materiales o productos incluidos en los Servicios. La Asociación no será responsable de ningún daño de ningún tipo que surja del uso de los Servicios, incluidos, entre otros, daños directos, indirectos, incidentales, punitivos y consecuentes. </p><p><b>Legislación aplicable </b></p><p>Estas Condiciones y su, e de los Servicios se regirá e interpretará de acuerdo con las leyes de Suiza y cualquier disputa se resolverá en los tribunales de Basilea, Suiza. </p><p><b>Cambios a los Términos </b></p><p>La Asociación se reserva el derecho de cambiar estos Términos en cualquier momento, y usted es responsable de revisar estos Términos periódicamente para ver si hay cambios. . Su uso continuado de los Servicios después de que se hayan realizado cambios en los Términos constituirá su aceptación de los Términos revisados.</p><p><br></p>",
    "about_modal_subtitle": "Acerca de",
    "about_modal_title": "Libro mayor farmacéutico",
    "about_content": "<iframe style=\"width: 100%; height: 100%; margin-bottom: 24px; border: 0\" src=\"https://pharmaledger.org\"></iframe>",
  ...
  "pt": {
    ...
    "scan_error_title": "Erro de verificação",
    ...
    "terms_content": "<p><b>Termos e condições para o site e aplicativo de informações eletrônicas sobre produtos da PharmaLedger Association </b></p><p>Acessando ou usando o site e o aplicativo Electronic Product Information da PharmaLedger Association (o \"Serviços\"), você concorda em cumprir estes termos e condições (os \"Termos\"). Você não pode acessar ou usar os Serviços se não concordar com estes Termos. Os Serviços são operados pelo PharmaLedger Association (a \"Associação\") e destinam-se ao uso por indivíduos que buscam informações sobre seus medicamentos. Uma rede multipartidária fornece os Serviços, e o fabricante do medicamento fornece as informações do produto exibidas por meio dos Serviços. A Associação atua como controladora de dados para estas informações. </p><p><b>Uso dos Serviços </b></p><p>Você concorda em usar os Serviços apenas para fins legais e de maneira que não infrinja os direitos de , ou restringir ou inibir o uso e aproveitamento dos Serviços por terceiros. Tal restrição ou inibição inclui, sem limitação, conduta que seja ilegal ou que possa assediar ou causar desconforto ou inconveniência a qualquer pessoa, e a transmissão de conteúdo obsceno ou ofensivo ou interrupção do fluxo normal de diálogo dentro dos Serviços. </p><p><b>Propriedade intelectual </b></p><p>O conteúdo dos Serviços, incluindo, entre outros, texto, gráficos, imagens e software, é propriedade do Association ou seus licenciadores e empresas membros e é protegido por direitos autorais e outras leis de propriedade intelectual. Você não pode usar nenhum conteúdo dos Serviços para fins comerciais sem o consentimento expresso por escrito da Associação. </p><p><b>Responsabilidade</b> </p><p>A Associação não faz representações ou garantias de qualquer tipo, expressas ou implícitas, quanto à operação dos Serviços ou às informações, conteúdo, materiais ou produtos incluídos nos Serviços. A Associação não será responsável por quaisquer danos de qualquer tipo decorrentes do uso dos Serviços, incluindo, entre outros, danos diretos, indiretos, incidentais, punitivos e consequentes. </p><p><b>Lei Aplicável </b></p><p>Estes Termos e sua Todos os Serviços serão regidos e interpretados de acordo com as leis da Suíça e quaisquer disputas serão resolvidas nos tribunais de Basel, Suíça. </p><p><b>Alterações nos Termos </b></p><p>A Associação reserva-se o direito de alterar estes Termos a qualquer momento, e você é responsável por verificar estes Termos periodicamente quanto a quaisquer alterações . Seu uso continuado dos Serviços após qualquer alteração nos Termos constituirá sua aceitação dos Termos revisados.</p><p><br></p>",
  ...
  "ko": {
    ...
    "terms_content": "<p><b>PharmaLedger 협회의 전자 제품 정보 웹사이트와 어플리케이션에 대한 약관 및 조건</b></p><p>PharmaLedger 협회의 전자 제품 정보 웹사이트와 어플리케이션(이하 '서비스')에 접속하거나 이를 이용함으로써, 귀하는 본 약관 및 조건(이하 '약관')에 동의하는 것입니다. 귀하는 본 약관에 동의하지 않으면 서비스에 접속하거나 이를 이용할 수 없습니다. 서비스는 PharmaLedger 협회(이하 '협회')가 운영하며, 약물 정보를 찾는 개인들이 이를 이용할 목적으로 제공됩니다. 다중 당사자 네트워크가 서비스를 제공하며, 약물 제조업체가 서비스를 통해 제공되는 제품 정보를 제공합니다. 협회는 이 정보의 데이터 컨트롤러로 작동합니다. </p><p><b>서비스 이용</b></p><p>귀하는 합법적인 목적으로만 서비스를 이용하며, 어떠한 제3자의 권리를 침해하지 않는 방식으로 서비스를 이용하시기로 동의합니다. 이러한 제한 또는 억제는 불법적인 행동, 혹은 어떠한 개인에게 괴롭힘 혹은 불편함을 초래할 수 있는 행동을 포함하며, obscenities나 offensive한 콘텐츠를 전송하거나, 서비스 내의 정상적인 대화 흐름을 방해하는 행동을 포함합니다. </p><p><b>지적 재산권</b></p><p>서비스의 콘텐츠, 텍스트, 그래픽, 이미지 및 소프트웨어 등은 협회 또는 그의 라이선서 및 회원 회사의 소유이며, 저작권 및 기타 지적 재산권 법으로 보호됩니다. </p><p><b>지적 재산권</b></p><p>텍스트, 그래픽, 이미지 및 소프트웨어를 포함한 서비스의 콘텐츠는 협회 또는 협회의 라이선서 및 회원 회사의 자산이며, 저작권 및 기타 지적 재산권법으로 보호됩니다. 협회의 명시적 서면 동의 없이는 서비스에서 콘텐츠를 상업적 용도로 사용할 수 없습니다. </p><p><b>책임제한 </b></p><p>협회는 서비스의 운영 또는 서비스에 포함된 정보, 콘텐츠, 자료 또는 제품에 대해 명시적 또는 묵시적으로 어떤 종류의 보증도 하지 않습니다. 협회는 직접적, 간접적, 부수적, 징벌적 및 결과적 손해를 포함한 서비스 사용으로 인해 발생하는 어떤 종류의 손해에 대해서도 책임을 지지 않습니다. </p><p><b>법률과 관할 법원 </b></p><p>이용약관과 서비스 사용은 스위스 법률에 따라 해석되고 규정되며, 모든 분쟁은 스위스 바젤 지방법원에서 해결됩니다. </p><p><b>약관 변경 </b></p><p>협회는 언제든지 이 약관을 변경할 권리를 보유하며, 사용자는 주기적으로 이 약관의 변경 사항을 확인할 책임이 있습니다. 약관 변경 사항이 있더라도 서비스를 계속 사용하는 경우 변경된 약관의 적용을 받는 것으로 간주됩니다. </p><p><br></p>",
